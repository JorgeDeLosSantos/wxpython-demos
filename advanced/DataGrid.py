...
#
"""
DataGrid is a enhanced class ( for numerical data) inherited 
from  wx.grid.Grid 
"""
...
class DataGrid(wxgrid.Grid):
    def __init__(self,parent,gridsize,**kwargs):
        ...
        self.SetSelectionBackground(wx.Colour(50,50,50))
    ...
    def edit_collabel(self,event):
        ...
        dlg = wx.TextEntryDialog(None, "Insert label...",
        "wxPython Demos")
